...
function sendEmails() {
    ...
    client.getObservationsByZipCode(options, function(err, observations) {
        if (err) {
            ...
            generateMail(observations);
        }
    });

    function generateMail(airnow) {

        // var username = "e57okwlgo3bwog2x@ethereal.email";
        // var password = "nFtxnpk8vcVhUChQGC";
        ...
        var lastname = "Marikwa";
        var email = "samsonmarikwa@outlook.com";
        var to = "'" + firstname + " " + lastname + " <" + email + ">'";
